            ...
            <tr key={request.id} className="border-b last:border-0">
              ...
              <td className="p-3">
                <div className="flex justify-end gap-1">
                  <Button variant="ghost" size="icon" onClick={() => onSearch(request.id)}><Search className="h-4 w-4" /></Button>
                  <Button variant="ghost" size="icon" onClick={() => onGrab(request.id)}><Download className="h-4 w-4" /></Button>
                  <Button variant="ghost" size="icon" onClick={() => onApprove(request.id)}><Check className="h-4 w-4" /></Button>
                  <Button variant="ghost" size="icon" onClick={() => onReject(request.id)}><X className="h-4 w-4" /></Button>
                </div>
              </td>
            </tr>
          ))}
            ...
            {candidates.slice(0, 12).map((candidate) => (
              <tr key={candidate.release.guid} className="border-b last:border-0">
                ...
                <td className="p-3 text-right">
                  <Button variant="ghost" size="icon" disabled={!candidate.decision.accepted} onClick={() => onGrab(candidate)}>
